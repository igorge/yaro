...
final class Vector4F(private var m_v0: Float, private var m_v1: Float, private var m_v2: Float, private var m_v3: Float)
  extends Vector4FMutable
  with VectorRead4FImplIndexAccessViaMembers
  with VectorWrite4FImplIndexAccessViaMembers
{
...
object Vector4F {
  ...
  def apply(vec: VectorRead3F, v3: Float) = {
    new Vector4F(vec.v0, vec.v1, vec.v2, v3)
  }

  def apply(v0: Float, vec: VectorRead3F) = {
    new Vector4F(v0, vec.v0, vec.v1, vec.v2)
  }
